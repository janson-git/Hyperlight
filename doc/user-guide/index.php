    ...
    <body>
        ...
        <div id="content">
            ...
            <div class="text">
                ...
                <?php $hl->highlight('$hl->highlight($code, $language);', 'iphp'); ?>
                ...
                <?php $hl->highlightFile('code1.php'); ?>
                <p>It really can’t get much simpler than that.</p>
                <p>Notice that we didn’t have to put special <acronym>HTML</acronym> tags around our code. 
                    <a href="../ref/#hyperlight-function"><code>hyperlight</code></a> does this for us. 
                    But don’t worry about lack of control. This function has two more optional arguments that 
                    you can use to control how these surrounding tags should look like. The first controls which 
                    surrounding tag to use and defaults to – what a surprise – 
                    <?php $hl->highlight('<pre>', 'xml', 'code'); ?>. 
                    The second argument controls the attributes that the tag should have 
                    (in addition to the <code>class</code>). For a detailed description of how to use these 
                    arguments, read the reference entry on the <a href="../ref/#hyperlight-function">
                        <code>hyperlight</code></a> function.</p>
                ...
                <?php $hl->highlight('$hl->highlight($code, \'iphp\');', 'iphp'); ?>
                ...
                <?php $hl->highlightFile('mini-zenburn.css'); ?>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <?php $hl->highlight('<span class="comment"><span class="todo">TODO:</class> i18n</span>', 'xml'); ?>
                    </li>
                    <li>
                        ...
                        <?php $hl->highlight('<span class="keyword builtin">isset</span>', 'xml'); ?>
                    </li>
                </ol>
                ...
                <li><code>keyword</code> – any keyword or reserved word in the language
                    <ul>
                        <li><code>builtin</code> – a built-in function, such as <?php $hl->highlight('isset', 'iphp', 'code'); ?></li>
                        <li><code>literal</code> – a built-in literal, such as <?php $hl->highlight('true', 'iphp', 'code'); ?></li>
                        <li><code>operator</code> – an operator keyword, such as <?php $hl->highlight('instanceof', 'iphp', 'code'); ?></li>
                        <li><code>preprocessor</code> – a preprocessor statement, such as <?php $hl->highlight('#define', 'cpp', 'code'); ?> in C++</li>
                        <li><code>type</code> – a built-in data type, such as <?php $hl->highlight('int', 'iphp', 'code'); ?></li>
                    </ul>
                </li>
